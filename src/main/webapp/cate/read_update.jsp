...
<jsp:include page="/menu/top.jsp" />
  ...
  <DIV class='title_line'><A href="../categrp/list.do">카테고리 그룹</A> > ${cateVO.name } 조회(수정) </DIV>
  ...
  <DIV id='panel_create' style='padding: 10px 0px 10px 0px; background-color: #F9F9F9; width: 100%; text-align: center;'>
    <FORM name='frm_update' id='frm_update' method='POST' action='./update.do'>
      ...
      <button type='button' onclick="location.href='../cate/list.do?categrpno=${param.categrpno}'">취소</button>
    </FORM>
  </DIV>
  ...
  <TABLE class='table table-striped'>
    ...
    <c:forEach var="cateVO" items="${list }">  <!-- request 객체에 접근 -->
      ...
      <TR>
        ...
        <TD class="td_bs_left"><A href="./read_update.do?cateno=${cateno }&categrpno=${param.categrpno}">${cateVO.name }</A></TD>
