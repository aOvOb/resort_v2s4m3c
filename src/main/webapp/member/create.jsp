...
<script type="text/javascript">
  $(function() { // 자동 실행
    ...
    $('#btn_close').on('click', setFocus); // Dialog창을 닫은 후의 focus 이동
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" id="btn_close" data-focus="" class="btn btn-default" data-dismiss="modal">닫기</button>
        </div>
      </div>
    </div>
  </div> <!-- ********** Modal 알림창 종료 ********** -->
