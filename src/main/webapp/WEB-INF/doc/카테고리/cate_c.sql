...
-- 3. CASCADE option을 이용한 자식 테이블을 무시한 삭제, 관련된 제약조건이 삭제됨
DROP TABLE cate CASCADE CONSTRAINTS;

/**********************************/
/* Table Name: 카테고리 그룹 번호 */
/**********************************/
...
COMMENT ON TABLE categrp is '카테고리 그룹 번호';
...
오류 보고 -
ORA-02291: integrity constraint (AI7.SYS_C007292) violated - parent key not found
-- FK 컬럼의 값 1000은 categrp테이블에 없어서 에러 발생함.
...
---------- -------------------------------------------------- ---------- - -------------------
         1 국내 여행                                                   1 Y 2020-10-23 02:43:50
         2 해외 여행                                                   2 Y 2020-10-23 02:43:50
         3 개발 자료                                                   3 Y 2020-10-23 02:43:50

-- 등록: 국내 여행지 중 가을 여행지 추천
INSERT INTO cate(cateno, categrpno, name, seqno, visible, rdate, cnt)
...
----------   ----------     ---------   ---------  ---  --------------------------    ------
    2              1             가을            1       Y    2020-10-23 02:51:08          0
    3              1             겨울            1       Y    2020-10-23 02:51:08          0
    4              1               봄             1       Y    2020-10-23 02:51:08          0
...
DELETE FROM categrp
WHERE categrpno = 1;
ORA-02292: integrity constraint (AI7.SYS_C007348) violated - child record found
